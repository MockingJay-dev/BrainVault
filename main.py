...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """
    Sends a welcome message to the user. No banner printed to console in production.
    """
    welcome_text = (
        "🧠━━━━━━━━━━━━━━━━━━━━━━━━━━━━━🧠\n"
        "<b>BRAIN VAULT - THE MOCKINGJAY</b>\n"
        "🧠━━━━━━━━━━━━━━━━━━━━━━━━━━━━━🧠\n\n"
...
async def view(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if args:
        ...
        if not entries:
            await update.message.reply_text(
                f"⚠️ No entries found for <code>#{cat_name}</code>.",
                parse_mode=ParseMode.HTML
            )
            return
